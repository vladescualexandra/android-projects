...
import com.example.dam_seminar_007.R;
...
public class BankAccountAdapter extends ArrayAdapter<BankAccount> {
    ...
    public BankAccountAdapter(@NonNull Context context,
                              int resource,
                              @NonNull List<BankAccount> objects,
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if (bankAccount != null) {
            buildBankAccount(view, bankAccount);
        }
        return view;
    }

    private void buildBankAccount(View view, BankAccount bankAccount) {
